      ...
      <div className="flex flex-col sm:flex-row mt-20 gap-[17px] justify-around ">
        <div className="flex gap-[10px]  m-auto  md:flex-row xl:gap-[16px] lg:gap-[10px] md:gap-[5px] sm:flex-col-reverse sm:gap-2  sm:items-center">
          <div className="flex md:flex-col  xl:gap-[16px] lg:gap-[10px] sm:gap-[5px] sm:flex-row flex-col gap-[8px]">
            <img
              src={product.image}
              className=" xl:h-[163px] lg:h-[120px] md:h-[80px] sm:h-[70px] h-[75px] "
            />
            <img
              src={product.image}
              className=" xl:h-[163px] lg:h-[120px] md:h-[80px] sm:h-[70px] h-[75px]"
          ...
          <div className="flex">
            <img
              src={product.image}
              className=" xl:w-[386px] xl:h-[700px] md:w-auto lg:h-[510px] sm:h-[335px] sm:w-[300px] h-[330px]"
            />{" "}
          </div>
        </div>
        ...
        <div className="xl:mx-[70px] lg:mx-[30px] flex flex-col lg:w-[600px] md:w-[400px] sm:w-[280px]  lg:gap-4 md:gap-[5px] sm:gap-1 gap-3">
          ...
          <p className="font-normal break-words mb-2  sm:text-sm ">
            "Striped Flutter Sleeve Overlap Collar Peplum Hem Blouse" – a
            stylish and comfortable addition to your wardrobe. This blouse
            boasts flutter sleeves, a unique overlap collar, and a flattering
            peplum hem, making it perfect for any occasion.
          </p>
          <hr />
          ...
          <div className="flex lg:mt-10  lg:mb-10 sm:mt-2 mt-8 gap-4 items-center">
            <div className="flex justify-center items-center gap-2 border-2 border-[#00000080] text-2xl  lg:text-2xl  sm:text-[16px]">
              <div
                className="px-1 border-r-2 border-[#00000080] "
                onClick={() => {
                  if (quantity > 1) {
              ...
              <div
                className=" border-l-2 border-[#00000080] "
                onClick={() => setQuantity(quantity + 1)}
              >
                <button className="bg-[#DB4444] px-1">+</button>
              </div>
            </div>
            <div
