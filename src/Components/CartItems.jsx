...
const CartItems = () => {
  ...
  return (
    <div className="w-[90%] ml-auto mr-auto mt-10 ">
      ...
      <div className="flex">
        <div className=" sm:w-[400px] w-[90%] mr-auto ml-auto flex flex-col border-2 border-black p-2 gap-3 sm:ml-auto my-20">
          ...
          <div className=" flex  justify-center text-white font-medium">
            <button className="bg-[#DB4444] p-2">Procced to Checkout</button>
          </div>
        </div>
      </div>
    </div>
